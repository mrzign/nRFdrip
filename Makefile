PROJECT_NAME := nRFdrip
SDK_PATH = nRF51_SDK_10
...
$(abspath $(SDK_PATH)/components/drivers_nrf/spi_master/nrf_drv_spi.c) \
...
INC_PATHS += -I$(abspath $(SDK_PATH)/components/drivers_nrf/pstorage/config)
